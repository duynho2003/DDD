...
/* 
1. viet stored procedure in ra cap nhat lai luong cb cua nhan vien dua vao 2 tham so input: ten nv va muc luong dieu chinh
		1 => in ds sv nam
		0 => in ds sv nu
...
/* 
2. viet stored procedure in ra cap nhat lai luong cb cua nhan vien dua vao 2 tham so input: ten nv va muc luong dieu chinh va tra ve so luong nv (output) co muc luong dc dieu chinh
*/
...
-- test case 2: giam luong 200$ cho cac nv co ho Nguyen
declare @dem_nv int
