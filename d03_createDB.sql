...
*/
 CREATE DATABASE dbSample2
	ON PRIMARY 
	(name='dbSample2', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbSample2.mdf', size=10, filegrowth=32, maxsize=unlimited)
	LOG ON
	(name='dbSample2_log', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbSample2_log.ldf', size=10, filegrowth=10%, maxsize=64)
GO
...
CREATE DATABASE dbSample3
	ON PRIMARY 
	(name='dbSample3a', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbSample3a.mdf', size=10, filegrowth=32, maxsize=unlimited),
	FILEGROUP ABC 
	(name='dbSample3b', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbSample3b.ndf')
	LOG ON
	(name='dbSample3_log', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbSample3_log.ldf')
GO
