...
on primary 
(name='ass10', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ass10.mdf', size=5, maxsize=50, filegrowth=10%),
filegroup Group1 
(name='ass10_1', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\\ass10_1.ndf', size=10, maxsize=unlimited, filegrowth=5)
log on
(name='ass10_log', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ass10_log.ldf', size=10, maxsize=unlimited, filegrowth=10%)
go
...
b. Create a composite index IX_CustMsg for CustCode and MsgNo columns on tbMessage table
*/
