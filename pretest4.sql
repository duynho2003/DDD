CREATE DATABASE dbPretest4
	ON PRIMARY 
	(name='dbpretest4', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbPretest4.mdf.', size=8, filegrowth=20, maxsize=unlimited)
	LOG ON
	(name='dbpretest4_log', filename='C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\dbpretest4_log.ldf', size=8, filegrowth=10%, maxsize=50)
