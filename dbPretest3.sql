...
set dateformat dmy
insert tbLeaveDetails values('NV02',5,'08-01-2022','12-01-2022','Busy')
go
--test case2: that bai
set dateformat dmy
insert tbLeaveDetails values('NV01',3,'01-01-2022','12-01-2022','Busy')
go
--test case3: thanh cong
set dateformat dmy
insert tbLeaveDetails values('NV03',6,'04-01-2022','10-01-2022','Busy')
go
--test case4: that bai
set dateformat dmy
insert tbLeaveDetails values('NV04',3,'31-12-2021','13-01-2022','Busy')
go
update tbLeaveDetails set LeaveTaken=10 where Emp_id='NV01'
go

delete from tbLeaveDetails where Emp_id='NV01'
select * from tbLeaveDetails
go
...
for update as
	begin
		...
		if (@newsalary = 0)
			begin
				if ((select count(*) from tbLeaveDetails where Emp_Id like @emp) = 0 )
					begin
